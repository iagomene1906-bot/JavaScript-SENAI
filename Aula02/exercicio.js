...
mudar1 = Number(padrao);
console.log(mudar1);
console.log(typeof mudar1);
mudar2 = String(mudar1);
console.log(mudar2);
...
let altura3 = prompt("E a sua altura:");
let peso = prompt("Quanto voce pesa");
let cidade3 = prompt("E onde você mora:");
